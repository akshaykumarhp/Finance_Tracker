    ...
    <div className="relative h-56" onMouseLeave={() => setHovering(false)}>
      <ResponsiveContainer width="100%" height="100%">
        <PieChart>
          ...
          <Tooltip
            ...
            contentStyle={{
              borderRadius: 12,
              border: dark ? "1px solid #334155" : "1px solid #e5e9f0",
              background: dark ? "#1e293b" : "#ffffff",
              boxShadow: "0 8px 24px -8px rgba(15,23,42,0.35)",
              padding: "6px 10px",
            }}
            itemStyle={{ color: dark ? "#f1f5f9" : "#1e293b", fontWeight: 500 }}
          />
        </PieChart>
      </ResponsiveContainer>
      ...
      {!hovering && (
        <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center">
          ...
          <span className="tnum text-lg font-bold text-ink-900 dark:text-white">
